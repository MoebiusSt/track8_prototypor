...
// erratic jumps at coarser grid settings. This roughly corresponds to the feel of 1/32 (mathematically, 1/32 = 12.5px / 6px ≈ 2.08, but 3.0 would give time spacing jumps slightly more weight)
  ...
  return (
    <div className="app-container">
      <nav className="demo-nav" aria-label="Demo views">
        <NavLink to="/overview" end className={({ isActive }) => `demo-nav-link${isActive ? ' demo-nav-link-active' : ''}`}>
          Main Overview
        </NavLink>
        <NavLink to="/piano" end className={({ isActive }) => `demo-nav-link${isActive ? ' demo-nav-link-active' : ''}`}>
          Piano roll
        </NavLink>
        <NavLink to="/waveform" end className={({ isActive }) => `demo-nav-link${isActive ? ' demo-nav-link-active' : ''}`}>
          Waveform
        </NavLink>
        <NavLink
          to="/timed-mute"
